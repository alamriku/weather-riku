...
GLoc = {
    ...
    geoSuccess: function() {
       ...
       // g.startPos = position;
        g.searchQuery = 'http://api.openweathermap.org/data/2.5/forecast?lat=22.3455&lon=91.8342&APPID=8504ad2e239ba1c0a67e331904d22d2b';
...
WeatherInfo = {
    ...
    getWeatherData: function(searchQuery) {
            ...
            w.searchQuery = 'http://api.openweathermap.org/data/2.5/forecast?lat=22.3455&lon=91.8342&APPID=8504ad2e239ba1c0a67e331904d22d2b';
    ...
    setWeatherData: function(data) {
        ...
        CanvasBackground.chooseBackground(data.list[0].weather[0].main);
